...
explicitly committed, using the :py:meth:`ctds.Connection.commit()` method, or
rolled back, using the :py:meth:`ctds.Connection.rollback` method.
...
committed after an operation and calls to :py:meth:`ctds.Connection.commit()`
